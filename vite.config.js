  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        short_name: "Blogs App",
        description:
          "A simple Progressive Web Application that allows users to explore and read various blogs. Stay updated with interesting topics, anytime, anywhere.",
        theme_color: "#7953D1FF",
        icons: [
          {
